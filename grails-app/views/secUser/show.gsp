...
<div id="wrapper">
		     ...
		     <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                  ...
                  <li>
                    ...
                    <li>
                        <a href="<g:createLink controller="secUser"  action="show" id="${secUserInstance.id}" />" class=" hvr-bounce-to-right"><i class="fa fa-dashboard nav_icon "></i><span class="nav-label" style="color: #ee148f;">Profile Page</span> </a>
                    </li>
					<li>
 	...
 	<!--banner-->	
		...
		<div class="profile-bottom">
			<h3><i class="fa fa-user" style="color: #ee148f;"></i>Profile</h3>
			<div class="profile-bottom-top">
			<div class="col-md-4 profile-bottom-img">
				<img src="${resource(dir: 'images', file: 'pr.jpg')}"" alt="">
			</div>
			<div class="col-md-8 profile-text">
				<h6 style="color: #ee148f;"><g:fieldValue bean="${secUserInstance}" field="employeeId"/></h6>
				<h3 style="color: #ee148f;"><g:fieldValue bean="${secUserInstance}" field="name"/></h3>
				
				<span><g:fieldValue bean="${secUserInstance}" field="primaryRole"/></span>
				<br><br>
				<table style="color: #ee148f;">
				<tr><td>Phone</td>  
				<td>:</td>  
				<td><g:fieldValue bean="${secUserInstance}" field="phone"/></td></tr>
				
				<tr>
				<td>Email</td>
				<td> :</td>
				<td><a href="info@gmail.com"><g:fieldValue bean="${secUserInstance}" field="email"/></a></td>
				</tr>
				<tr>
				<td>Joining Date</td>
				<td> :</td>
				...
				<td>:</td>
				<td>
				<g:if test="${secUserInstance?.leaves}">
				<g:each in="${secUserInstance.leaves}" var="l">
				<br>
			...
			<ol class="property-list employee">
				...
				<li class="fieldcontain">
					<span id="phone-label" class="property-label"><g:message code="employee.phone.label" default="Phone" /></span>
						...
						<span class="property-value" aria-labelledby="phone-label"></span>
